...
<body class="bg-gray-100">
    ...
    <div class="bg-black text-white hidden sm:block">
        <div class="flex justify-end items-center py-2 px-4">
            <a href="#" class="p-2"><i class="fa fa-facebook-official"></i></a>
            <a href="#" class="p-2"><i class="fa fa-instagram"></i></a>
            <a href="#" class="p-2"><i class="fa fa-snapchat"></i></a>
            <a href="#" class="p-2"><i class="fa fa-flickr"></i></a>
            <a href="#" class="p-2"><i class="fa fa-twitter"></i></a>
            <a href="#" class="p-2"><i class="fa fa-linkedin"></i></a>
            <a href="#" class="ml-auto p-2"><i class="fa fa-search"></i></a>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <header class="py-12 text-center bg-white">
            <h1 class="text-5xl font-bold">JANE BLOGLIFE</h1>
            <h6 class="text-sm"><span class="bg-gray-300 px-2 py-1 rounded">Jane's world</span></h6>
        </header>

        <!-- Image header -->
        <section id="home" class="relative">
            <img src="https://profit.pakistantoday.com.pk/wp-content/uploads/2023/07/pp.jpg" alt="Fashion Blog"
                class="object-cover object-center w-full h-full">
            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                <div class="text-white text-center">
                    <h1 class="text-4xl sm:text-6xl lg:text-7xl font-bold mb-4">Jane's</h1>
                    <h1 class="text-4xl sm:text-6xl lg:text-7xl font-bold mb-8 sm:mb-12 lg:mb-16">FASHION BLOG</h1>
                    <button class="px-8 py-4 bg-white text-gray-800 font-bold text-sm sm:text-base rounded-full
                        opacity-75 hover:opacity-100 transition duration-300"
        ...
        <!-- Main content -->
        <main class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">

            <!-- Blog entries -->
            <div class="md:col-span-2 space-y-8">

                <!-- Blog entry -->
                <article class="bg-white p-8 shadow-md rounded-lg">
                    <div class="text-center">
                        <h3 class="text-2xl font-bold">TITLE HEADING</h3>
                        <h5 class="text-sm text-gray-500">Title description, <span class="opacity-75">May 2, 2016</span></h5>
                    </div>

                    <div class="mt-4">
                        <img src="https://images.pexels.com/photos/1092644/pexels-photo-1092644.jpeg?cs=srgb&dl=pexels-fotios-photos-1092644.jpg&fm=jpg"
                            alt="Girl Hat" class="w-full rounded-lg">
                        <p class="mt-4"><strong>More Hats!</strong> I am crazy about hats these days. Some text about this blog entry.
                            Fashion fashion and mauris neque quam, fermentum ut nisl vitae, convallis maximus nisl. Sed mattis nunc id lorem
                            euismod placerat. Vivamus porttitor magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies mi non congue
                            ullam corper. Praesent tincidunt sedtellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <button class="px-4 py-2 bg-white border border-gray-300 text-gray-700 font-bold rounded-md
                                hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400"
                                onclick="likeFunction(this)"><i class="fa fa-thumbs-up mr-2"></i> Like</button>
                            <button class="px-4 py-2 bg-black text-white font-bold rounded-md
                                hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400"
                                onclick="myFunction('demo1')" id="myBtn"><i class="fa fa-comments mr-2"></i> Replies <span
                                    class="bg-white text-black rounded-full px-2 py-1">1</span></button>
                        </div>
                        <div class="w3-row w3-margin-bottom" id="demo1" style="display:none">
                            <hr>
                            <div class="flex items-center mt-4">
                                <img src="https://media.licdn.com/dms/image/D5612AQFvB1dRFhJ82A/article-cover_image-shrink_600_2000/0/1673178585793?e=2147483647&v=beta&t=F9bQFch9cxR77yLEC6WKa-Wkyub-ex8by1-wtRuzvYo"
                                    alt="George" class="rounded-full w-16 h-16">
                                <div class="ml-4">
                                    <h4 class="text-lg font-semibold">George <span class="opacity-75 text-sm">May 3, 2015, 6:32 PM</span>
                                    </h4>
                                    <p class="mt-2">Great blog post! Following</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <article class="bg-white p-8 shadow-md rounded-lg">
                    <div class="text-center">
                        <h3 class="text-2xl font-bold">TITLE HEADING</h3>
                        <h5 class="text-sm text-gray-500">Title description, <span class="opacity-75">April 23, 2016</span></h5>
                    </div>

                    <div class="mt-4">
                        <img src="https://img.uswitch.com/n36b8lzdmgnp/6flMYPMjJ0sZzNs16Fsqa/c525a3f838b0e62716631f003390506b/shutterstock_1736005427212121212.jpg?auto=format%2Ccompress&fit=crop&crop=faces%2Centropy&ar=16%3A9&fill=solid&q=35&ixlib=react-9.5.1-beta.1"
                            alt="Men in Hats" class="w-full rounded-lg">
                        <p class="mt-4"><strong>Hats!</strong> The trend this summer is hats for men!</p>
                        <p>Some text about this blog entry. Fashion fashion and mauris neque quam, fermentum ut nisl vitae, convallis maximus
                            nisl. Sed mattis nunc id lorem euismod placerat. Vivamus porttitor magna enim, ac accumsan tortor cursus at. Phasellus
                            sed ultricies mi non congue ullam corper. Praesent tincidunt sedtellus ut rutrum. Sed vitae justo condimentum, porta
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <button class="px-4 py-2 bg-black text-white font-bold rounded-md
                                hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400"
                                onclick="myFunction('demo2')" id="myBtn"><i class="fa fa-comments mr-2"></i> Replies <span
                                    class="bg-white text-black rounded-full px-2 py-1">2</span></button>
                        </div>
                        <div class="w3-row w3-margin-bottom" id="demo2" style="display:none">
                            <hr>
                            <div class="flex items-center mt-4">
                                <img src="https://www.allianzcare.com/Allianz_Care/media/images/News%20and%20Media/shutterstock_162304530.jpg"
                                    alt="Dennis" class="rounded-full w-16 h-16">
                                <div class="ml-4">
                                    <h4 class="text-lg font-semibold">Dennis <span class="opacity-75 text-sm">April 25, 2016, 9:12 PM</span>
                                    </h4>
                                    <p class="mt-2">I like the hats! Awesome post!</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <aside class="md:col-span-1 space-y-8">
                ...
                <section class="bg-white p-8 shadow-md rounded-lg">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGe8TeItAQNqszkr2JZ0LldSBvSm_bC700UjOtZLj4n49nUzegQXwukOxslQc7jbLrEMA&usqp=CAU"
                        alt="Jane" class="w-full rounded-lg">
                    <div class="text-center mt-4">
                        <h3 class="text-xl font-bold">My Name</h3>
                        <p class="mt-2">Just me, myself and I, exploring the universe of unknownment. I have a heart of love and an interest
                            in lorem ipsum and mauris neque quam blog. I want to share my world with you.</p>
                    </div>
                </section>

                <!-- Popular Posts -->
                <section class="bg-white p-8 shadow-md rounded-lg">
                    <h2 class="text-lg font-bold mb-4">Popular Posts</h2>
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <img src="https://friendshome.pk/cdn/shop/files/UntitledProject_17_684fad1d-de8d-4e45-8d79-a39f3e26ee11.jpg?v=1712130720&width=1000" alt="High
                                Heel" class="rounded-lg w-16 h-16">
                            <div class="ml-4">
                                <h4 class="font-semibold">Top 5 trends this summer</h4>
                                <p class="text-sm text-gray-500">June 22, 2016</p>
                            </div>
                        </div>
                        <div class="flex items-center">
                            <img src="https://propakistani.pk/wp-content/uploads/2023/12/iPhone-15-Pro-e1702381232998.jpg"
                                alt="High Heel" class="rounded-lg w-16 h-16">
                            <div class="ml-4">
                                <h4 class="font-semibold">New outfit ideas</h4>
                                <p class="text-sm text-gray-500">June 15, 2016</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="bg-white p-8 shadow-md rounded-lg">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="bg-gray-200 text-gray-800 px-3 py-1 rounded-full">Fashion</span>
                        <span class="bg-gray-200 text-gray-800 px-3 py-1 rounded-full">Trends</span>
                        <span class="bg-gray-200 text-gray-800 px-3 py-1 rounded-full">Style</span>
                        <span class="bg-gray-200 text-gray-800 px-3 py-1 rounded-full">Hats</span>
                        <span class="bg-gray-200 text-gray-800 px-3 py-1 rounded-full">Summer</span>
                        <span class="bg-gray-200 text-gray-800 px-3 py-1 rounded-full">Fashion Blog</span>
                    </div>
                </section>
    ...
    <!-- Subscribe Modal -->
    <div id="subscribe" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg">
            <i onclick="document.getElementById('subscribe').style.display='none'"
                class="fa fa-remove text-gray-500 text-2xl absolute top-4 right-4 cursor-pointer"></i>
            <h2 class="text-3xl font-bold text-center mb-4">SUBSCRIBE</h2>
            <p class="text-center mb-4">Join my mailing list to receive updates on the latest blog posts and other things.</p>
            <input type="email" class="w-full border py-2 px-3 mb-4" placeholder="Enter your email">
            <button class="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-2 rounded-lg"
